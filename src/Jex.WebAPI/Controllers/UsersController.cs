...
public sealed class UsersController(ISender sender) : ControllerBase
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return Ok(ApiResponse<List<UserDto>>.Success(HttpContext.TraceIdentifier, result));
    }
    ...
    public async Task<IActionResult> GetById(long id, CancellationToken cancellationToken)
    {
        ...
        return Ok(ApiResponse<UserDto>.Success(HttpContext.TraceIdentifier, result));
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        return Ok(ApiResponse<object>.Success(HttpContext.TraceIdentifier, new { id }));
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        return Ok(ApiResponse<object>.Success(HttpContext.TraceIdentifier, null));
    }
